...
Permite marcar productos como favoritos y hacer seguimiento
de sus precios de un vistazo.
"""
...
if not df_favoritos.empty:
    ...
    st.info(
        ...
        "Usa el buscador de arriba para añadir productos que quieras seguir."
    )
